...
namespace CatLog.Api.Helpers
{
    ...
    public static class ObjectExtensions
    {
        ...
        /// <param name="select">Uri Query 中的 fields 字符串，用于指明需要的属性/字段；如果需要所有属性传入 null 即可</param>
        /// <returns>塑形后的资源</returns>
        public static ExpandoObject ShapeData<TSource>(this TSource source, string select)
        {
            if (source == null)
            {
            ...
            {
                var fieldsAfterSpilt = select.Split(",");
